...
modified version of https://github.com/SpaceNetChallenge/RoadDetector/blob/master/albu-solution/src/skeleton.py
"""
...
def build_wkt_dir(indir, outfile, out_ske_dir, out_gdir='', thresh=0.3, #threshes={'2': .3, '3': .3, '4': .3, '5': .2}, 
                ...
                max_out_size=(100000, 100000),
                skeleton_band='all'):
    '''Exectue built_graph_wkt for an entire folder
